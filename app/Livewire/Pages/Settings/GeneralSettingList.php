...
class GeneralSettingList extends Component implements HasForms, HasTable
{
                ...
                CreateAction::make()
                    ...
                    ->successNotification(
                        Notification::make()
                            ...
                            ->body('General Setting has been created successfully.'),
                    ),
            ])
            ->query(
                Setting::query()
                ...
                EditAction::make()
                    ...
                    ->successNotification(
                        Notification::make()
                            ...
                            ->body('General Settings has been updated successfully.'),
                    ),
                DeleteAction::make(),
    ...
    {
        return view('livewire.pages.settings.general-setting-list');
    }
}
