...
<div>
    ...
    <form wire:submit="login">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-primary-button class="fi-color-custom fi-btn-color-primary fi-color-primary bg-custom-600 text-white hover:bg-custom-500 dark:bg-custom-500 dark:hover:bg-custom-400  ms-3">
                {{ __('Log in') }}
            </x-primary-button>
        </div>
    </form>
